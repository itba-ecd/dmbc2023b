...
PARAM$experimento <- "HT7230"

PARAM$experimento_input <- "TR7120"
...
setwd("X:\\gdrive\\ITBA2023dmbcB\\exp\\") # Establezco el Working Directory


# cargo el dataset donde voy a entrenar el modelo
arch_dataset <- paste0( "./", PARAM$experimento_input, "/", "train.csv.gz" )
