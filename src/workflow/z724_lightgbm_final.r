...
PARAM$experimento_dataset <- "TR7120"


PARAM$finalmodel$semilla <- 102191


# aqui debo copiar los hiperparametros optimos de la Optimizacion Bayesiana
...
setwd("X:\\gdrive\\ITBA2023dmbcB\\exp\\")

# cargo el dataset donde voy a entrenar
arch_dataset <- paste0( "./", PARAM$experimento_dataset, "/", "final_train.csv.gz" )
dataset <- fread(arch_dataset)

arch_future <- paste0( "./", PARAM$experimento_dataset, "/", "future.csv.gz" )
dataset_future <- fread(arch_future)
